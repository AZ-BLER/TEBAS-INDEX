...
echo $yellow
figlet -f future "Light Cyber Indonesia"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Azbler"$cyan" ~/LCI"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Azbler"$cyan" ~/LCI"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"Azbler"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"Azbler"$cyan" ~/LCI"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"Azbler"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author   : Azbler			"
echo $purple"Gthub   : https://github.com/AZ-BLER"
echo $white"Youtube  : https://youtube.com/Azbler ZX"
echo
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Terimakasih Sudah Menggunakan Tools Ini ya Gan :) "
exit
clear
fi
